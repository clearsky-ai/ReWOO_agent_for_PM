...
For example:
Task: Find the bottlenecks and inefficiencies in process based on the folowing event log, filepath=./Event_Logs/BPI_Challenge_2013_incidents.xes. This is the process of managing IT incidents at Volvo, provide common causes for the inefficiencies in this process. Please use the DFG approach.
Plan: Create a process model and find the top 3 inefficiencies #E1 = ProcessDiscovery_DFG[./Event_Logs/BPI_Challenge_2013_incidents.xes] 
...
Task: Find the bottlenecks and inefficiencies in process based on the folowing event log, filepath=./Event_Logs/BPI_Challenge_2012.xes. This is the manufacturing process at Siemens, provide common causes for the inefficiencies in this process. Please use the Temporal profile approach.
Plan: Create a process model and find the top 3 inefficiencies #E1 = ProcessDiscovery_Temporal_Profile[./Event_Logs/BPI_Challenge_2012.xes] 
Plan: The previous step provided 3 inefficiencies, I need to capture those in separate evidence variables. For the first one: #E2 = LLM[ What is the first found process inefficiency in the following structured list. Only state the two components of the process step in your answer, like: 'Created -> Finished'. Do not say anything else! The message: \n #E2 ]
Plan: The previous step provided 3 inefficiencies, I need to capture those in separate evidence variables. For the second one: #E3 = LLM[ What is the second found process inefficiency in the following structured list. Only state the two components of the process step in your answer, like: 'Created -> Finished'. Do not say anything else! The message: \n #E2 ]
Plan: The previous step provided 3 inefficiencies, I need to capture those in separate evidence variables. For the third one: #E4 = LLM[ What is the third found process inefficiency in the following structured list. Only state the two components of the process step in your answer, like: 'Created -> Finished'. Do not say anything else! The message: \n #E2 ]
...
Task: Find the bottlenecks and inefficiencies in process based on the folowing event log, filepath=./Event_Logs/BPI_Challenge_2011.xes. This is the patient registration process at St Jude Hospital, provide common causes for the inefficiencies in this process. Please use the Variants approach.
Plan: Create a process model and find the top 3 inefficiencies #E1 = ProcessDiscovery_Temporal_Profile[./Event_Logs/BPI_Challenge_2011.xes] 
...
For example:
Task: What are the audit risks in the process based on the folowing event log, filepath=./Event_Logs/BPI_Challenge_2013_incidents.xes. This is the process of managing IT incidents at Volvo, provide specific audit risks for the most 'risky' process steps. Please use the DFG approach.
Plan: Create a process model and find the top 3 inefficiencies #E1 = ProcessDiscovery_DFG[./Event_Logs/BPI_Challenge_2013_incidents.xes] 
